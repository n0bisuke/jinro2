...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('controllers').controller('RegisterCtrl', [
	    ...
	    function ($scope, $location, UserModel, AccountModel, storage) {
	        //ユーザー登録
	...
	angular.module('controllers').controller('RoomCtrl', [
	    ...
	    function ($scope, $location, UserModel, AccountModel, storage, RoomModel) {
	        ...
	        $scope.$watch('num', function(){
	            $scope.roomEx = __webpack_require__(28)($scope.num).mes;
	        });
	    }
	]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('services').factory('AccountModel', [
	    ...
	    function (storage) {
	        return {
	            //アカウント登録
	            register: function(email, password, options, cb){
	                //ポイント
	                options.point = {
	                    total: 0,
	                    wp: 0
	    ...
	    function (storage) {
	        return {
	            ...
	            init: function(room_name, num){
	                ...
	                var config = __webpack_require__(28)(num);
